...
require cc_path + '/app/indexers/curation_concerns/indexes_workflow.rb'
...
require cc_path + '/app/models/concerns/curation_concerns/suppressible.rb'
...
require cc_path + '/app/models/concerns/curation_concerns/collection.rb'
require cc_path + '/app/models/concerns/curation_concerns/collection_behavior.rb'
require cc_path + '/app/models/concerns/curation_concerns/basic_metadata.rb'
require cc_path + '/app/models/concerns/curation_concerns/file_set/characterization.rb'
require cc_path + '/app/models/concerns/curation_concerns/file_set/derivatives.rb'
require cc_path + '/app/models/concerns/curation_concerns/file_set/indexing.rb'
require cc_path + '/app/models/concerns/curation_concerns/file_set/querying.rb'
require cc_path + '/app/models/concerns/curation_concerns/file_set/belongs_to_works.rb'
require cc_path + '/app/services/curation_concerns/local_file_service.rb'
require cc_path + '/app/services/curation_concerns/persist_derivatives.rb'
require cc_path + '/app/services/curation_concerns/persist_directly_contained_output_file_service.rb'
require cc_path + '/app/models/concerns/curation_concerns/file_set_behavior.rb'
require cc_path + '/app/indexers/curation_concerns/file_set_indexer.rb'
